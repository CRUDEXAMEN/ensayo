    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return _dbMysql.pool.query("CALL sp_MostrarFactura(".concat(id, ");"));
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _dbMysql.pool.query("CALL sp_ListarFactura();");
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 2;
          _context3.next = 5;
          return _dbMysql.pool.query("CALL sp_CrearFactura('".concat(nombre, "','").concat(total, "'); "));
        case 5:
          respuesta = _context3.sent;
          if (respuesta[0].affectedRows == 1) {
            res.json({
              "res": "Factura creada correctamente"
            });
          } else {
            res.json({
              "err": "No se puede crear su factura"
            });
          }
          _context3.next = 12;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 3;
          _context4.next = 6;
          return _dbMysql.pool.query("CALL sp_ModificarFactura(".concat(id, ", '").concat(nombre, "','").concat(total, "'); "));
        case 6:
          respuesta = _context4.sent;
          if (respuesta[0].affectedRows == 1) {
            res.json({
              "res": "Factura modificada correctamente"
            });
          } else {
            res.json({
              "err": "No se puede modificar su factura"
            });
          }
          _context4.next = 13;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 2;
          _context5.next = 5;
          return _dbMysql.pool.query("CALL sp_EliminarFactura\t(".concat(id, "); "));
        case 5:
          respuesta = _context5.sent;
          if (respuesta[0].affectedRows == 1) {
            res.json({
              "res": "Factura elimanada correctamente"
            });
          } else {
            res.json({
              "err": "No se puede eliminar su factura"
            });
          }
          _context5.next = 12;
          break;
